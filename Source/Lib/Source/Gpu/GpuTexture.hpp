...
namespace AIHoloImager
{
    ...
    public:
        ...
        GpuTexture(GpuSystem& gpu_system, D3D12_RESOURCE_DIMENSION dim, uint32_t width, uint32_t height, uint32_t depth,
            uint32_t array_size, uint32_t mip_levels, DXGI_FORMAT format, D3D12_RESOURCE_FLAGS flags, std::wstring_view name = L"");
    ...
    public:
        ...
        GpuTexture2D(GpuSystem& gpu_system, uint32_t width, uint32_t height, uint32_t mip_levels, DXGI_FORMAT format,
            D3D12_RESOURCE_FLAGS flags, std::wstring_view name = L"");
    ...
    public:
        ...
        GpuTexture2DArray(GpuSystem& gpu_system, uint32_t width, uint32_t height, uint32_t array_size, uint32_t mip_levels,
            DXGI_FORMAT format, D3D12_RESOURCE_FLAGS flags, std::wstring_view name = L"");
