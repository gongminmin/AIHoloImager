...
namespace AIHoloImager
{
    ...
    public:
        ...
        D3D12Resource(GpuSystem& gpu_system, void* native_resource, std::string_view name);
    ...
    protected:
        ...
        void CreateResource(GpuResourceType type, uint32_t width, uint32_t height, uint32_t depth, uint32_t array_size, uint32_t mip_levels,
            GpuFormat format, GpuHeap heap, GpuResourceFlag flags, GpuResourceState init_state, std::string_view name);
